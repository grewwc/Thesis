        ...
        \subsection{PSR J0218+4232}
          ...
          \subsubsection{Spectra Fitting}
            ...
            \begin{figure}[!ht]
              \begin{minipage}{0.32\textwidth}
                \begin{center} 
                  \includegraphics[scale=1]{/Users/grewwc/Desktop/Thesis/diff_log_scale_0218.png}
                \end{center}
              \end{minipage}
              \begin{minipage}{0.32\textwidth}
                \begin{center}
                  \includegraphics[scale=1]{/Users/grewwc/Desktop/Thesis/diff_linear_scale_0218.png}
                \end{center}
              \end{minipage}
              \begin{minipage}{0.32\textwidth}
                \begin{center}
                \includegraphics[scale=1]{/Users/grewwc/Desktop/Thesis/diff_squareroot_scale_0218.png}
                \end{center}
              \end{minipage}
  
              \centering
              \begin{minipage}{0.8\textwidth}
                \mycaption{The residual maps show the difference between the observation and the model. 
                    They are generated by subtracting the photon counts of each pixel between the count maps 
                    of observation data and the model. From left to right, the residual map is in "log" scale, 
                    "linear" scale and "square root" scale respectively. 
                    \add{add color bar. }}
                \label{fig: j0218_count_map_diff}
              \end{minipage}
            \end{figure}
            ...
            number of absolute photon counts between the model and the observation differs a lot. However, 
            it is acceptable because the difference is small compared with the the absolute number of 
            photon counts. The absolute values
            of most of other pixels are less than 10 implying that our spectra model gives a good 
            simulation. 
            ...
            \begin{table}[!ht]
              \centering
                \begin{tabular}{|c|c|c|c|c|}
                  ...
                  % \hline 
                  % Prefactor ($N_{0}$) & $1.71\times 10^{-11}$ & $0.0610\times 10^{-12}$ & here & here \\
                  % \hline
                  % Index1 ($\gamma_1$) & $1.8999$ & 0.0395 & here & here \\
                  % \hline 
                  % Cutoff ($E_c$, MeV) & $3794.25$ & $396.447$ & here  &  here \\
                  \hline 
                  a & b & c & d & e\\ 
                  \hline
                \end{tabular}    
            ...
            \ref{fig: J0218+4232} showing. The prediction of the two-layer model is consistent with the observation
