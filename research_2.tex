...
\title{\textbf{Thesis Title}\\ \vspace{1cm}
			...
			{\includegraphics[scale=0.2]{{C:/Users/User/Desktop/Thesis/hku.png}}}\\ \vspace{3cm}
}
\date{}
...
\chapter{Introduction}   	   
    \section{Neutron Stars and Pulsars}
        ...
        \begin{figure}[h]
          \centering
          \includegraphics[scale=0.35]{C:/Users/User/Desktop/Thesis/pulsar_distribution.png}
    ...
    \section{Emission Mechanism of Pulsars}
        ...
        \subsection{Magnetic Dipole Model}
            ...
            \begin{figure}[!h]
              \centering
              \includegraphics[scale=0.6]{C:/Users/User/Desktop/Thesis/table.png}
    ...
    \section{Millisecond Pulsar} 
        ...
        \begin{figure}[h]
            \centering
            \includegraphics[scale=0.35]{{C:/Users/User/Desktop/Thesis/ppdot.png}}
        ...
        \subsection{Origin Of Millisecond Pulsars}
            ...
            \subsubsection{Mass Transfer And Accretion In Binary Systems}
                ...
                \begin{figure}[h]
                  \centering
                  \includegraphics[scale=0.5]{C:/Users/User/Desktop/Thesis/roche_lobes.jpg}
        ...
        \subsection{Class II MSPs}
            \begin{figure}[h!]   
                \centering
                \includegraphics[width=6.7cm,height=7cm]{{C:/Users/User/Desktop/Thesis/bands.png}}
    ...
    \section{NuSTAR}  
        ...
        \begin{figure}[h] 
            \centering
            \includegraphics[scale=0.6]{{C:/Users/User/Desktop/Thesis/nustar.png}}
        ...
        \subsection{Detectors} 
            ...
            \begin{figure}[h]  
                ...
                \begin{minipage}[c]{0.4\textwidth}
                    \includegraphics[width=5cm,height=5cm]{{C:/Users/User/Desktop/Thesis/detector.png}}
                \end{minipage}
                \hspace{0.5cm} 
                \begin{minipage}[c]{0.4\textwidth}
                    \includegraphics[width=5cm,height=5cm]{{C:/Users/User/Desktop/Thesis/sheld.png}}
                \end{minipage}
                \newline
        ...
        \subsection{Optics}
            ...
            \begin{figure}[h]
                \centering
                \includegraphics[scale=0.6]{{C:/Users/User/Desktop/Thesis/lightscheme.png}}
        ...
        \subsection{Mast}
            ...
            \begin{figure}[h!]
              \centering
              \includegraphics[scale=0.35]{C:/Users/User/Desktop/Thesis/nustar_mast.png}
        ...
        \subsection{Performance of NuSTAR}
            ...
            \begin{figure}[h!]
              \centering
              \includegraphics[scale=0.35]{C:/Users/User/Desktop/Thesis/effect_area.png}
            ...
            \begin{figure}[!htp]
              \centering
              \includegraphics[scale=0.27]{C:/Users/User/Desktop/Thesis/psf.png}
              \mycaption{Image of NuSTAR's point spread function of optics module A(left) and B(right).}
              \label{fig:psf}
              \vspace{1.5cm} 
              \includegraphics[scale=0.35]{C:/Users/User/Desktop/Thesis/psf_relation.png}
        ...
        \section{The Procedures of Processing NuSTAR Data}
            ...
            \vspace{0.2cm}
                ...
                \begin{flushright} 
                \includegraphics[scale=0.31]{C:/Users/User/Desktop/Thesis/A_uf.png}
             %\caption{raw picture}
            \end{flushright}
            \end{minipage}
            \hspace{1cm}
            \begin{minipage}{0.45\textwidth}
              \begin{flushleft}
                \includegraphics[scale=0.35]{C:/Users/User/Desktop/Thesis/A_cl.png}
              \end{flushleft} 
            \end{minipage}
            \centering
            ...
            \begin{figure}[h] 
              \centering
              \includegraphics[scale=0.34]{C:/Users/User/Desktop/Thesis/grade.png}
              \begin{minipage}[c]{0.85\textwidth}
...
\chapter{Data Analysis}
    ...
    \section{Data Analysis of Pulsar B1937+21 Using NuSTAR}
        ...
        \begin{figure}[h]
          ...
          \begin{minipage}{0.45\textwidth} 
            \centering 
            \includegraphics[scale=0.33]{C:/Users/User/Desktop/Thesis/A01.png}
            \caption{\textit{\footnotesize Sky image of module A}}
          \end{minipage}
          \hspace{0.1cm} 
          \begin{minipage}{0.52\textwidth}
            \centering 
            \includegraphics[scale=0.39]{C:/Users/User/Desktop/Thesis/B01.png}
        ...
        \begin{figure}[h]
          \begin{minipage}{0.45\textwidth} 
            \begin{flushright} 
            \includegraphics[scale=0.35]{C:/Users/User/Desktop/Thesis/A01_region.png}
            \end{flushright}
          \end{minipage}
          \hspace{2.1cm}  
          \begin{minipage}{0.45\textwidth}
            \begin{flushleft}
            \includegraphics[scale=0.42]{C:/Users/User/Desktop/Thesis/B01_region.png}
            \end{flushleft}
          \end{minipage}
          \begin{center}
        ...
        \begin{figure}[h]
          \begin{minipage}{1\textwidth}
            \begin{center}
                \includegraphics[scale=0.31]{C:/Users/User/Desktop/Thesis/A_lc.png}
         ...
         \\ 
          \begin{minipage}{\textwidth}
            \centering
            \includegraphics[scale=0.34]{C:/Users/User/Desktop/Thesis/B_lc.png}
        ...
        \begin{figure}[!ht]
          \begin{minipage}{0.45\textwidth}
            \begin{flushleft} 
                \includegraphics[scale=0.45]{C:/Users/User/Desktop/Thesis/a_1.png}
            \end{flushleft}
            \end{minipage}
          \begin{minipage}{0.45\textwidth}
            \begin{flushleft}
            \includegraphics[scale=0.52]{C:/Users/User/Desktop/Thesis/b_1.png}
            \end{flushleft}
          \end{minipage}
          \centering
          \begin{minipage}{0.8\textwidth}
        ...
        \begin{figure}[!ht]
          \begin{minipage}{0.45\textwidth}
            \begin{center} 
                \includegraphics[scale=0.36]{C:/Users/User/Desktop/Thesis/A_region2.png}
            \end{center}
            \end{minipage}
          \begin{minipage}{0.45\textwidth}
            \begin{center}
            \includegraphics[scale=0.42]{C:/Users/User/Desktop/Thesis/B_region2.png}
            \end{center}
          \end{minipage}
          \centering
          \begin{minipage}{0.8\textwidth}
        ...
        \begin{figure}[!ht]
          \begin{minipage}{0.45\textwidth}
            \begin{center} 
                \includegraphics[scale=0.42]{C:/Users/User/Desktop/Thesis/region2_problem.png}
            \end{center}
            \end{minipage}
          \begin{minipage}{0.45\textwidth}
            \begin{center}
            \includegraphics[scale=0.42]{C:/Users/User/Desktop/Thesis/bkregion_3.png}
            \end{center}
          \end{minipage}
          \centering
          \begin{minipage}{0.8\textwidth}
        ...
        \begin{figure}[!ht]  
          \begin{minipage}{1\textwidth}
            \begin{center} 
                \includegraphics[scale=0.4]{C:/Users/User/Desktop/Thesis/lc_a_region3.png}
                \mycaption{Light curve of module A}
          ...
          \begin{minipage}{1\textwidth}
            \begin{center}
            \includegraphics[scale=0.4]{C:/Users/User/Desktop/Thesis/lc_b_region3.png}
            \mycaption{Light curve of module B}
        ...
        \begin{figure}[!ht]
          \begin{minipage}{0.45\textwidth}
            \begin{center} 
                \includegraphics[scale=0.45]{C:/Users/User/Desktop/Thesis/spec_a.png}
            \end{center}
            \end{minipage}
          \begin{minipage}{0.45\textwidth}
            \begin{center}
            \includegraphics[scale=0.45]{C:/Users/User/Desktop/Thesis/spec_b.png}
            \end{center}
          \end{minipage}
          \centering
          \begin{minipage}{0.8\textwidth}
        ...
        \begin{figure}[!ht] 
          \begin{minipage}{1\textwidth}
            \begin{center} 
                \includegraphics[scale=0.42]{C:/Users/User/Desktop/Thesis/a_gti.png}
          ...
          \begin{minipage}{1\textwidth}
           \begin{center}
            \includegraphics[scale=0.42]{C:/Users/User/Desktop/Thesis/b_gti.png}
        ...
        \begin{figure}[!ht] 
          \begin{minipage}{0.45\textwidth}
            \begin{flushleft} 
                \includegraphics[scale=0.45]{C:/Users/User/Desktop/Thesis/spec_usrgti_a.png}
            \end{flushleft}
            \end{minipage}
          \begin{minipage}{0.45\textwidth}
            \begin{flushleft}
            \includegraphics[scale=0.45]{C:/Users/User/Desktop/Thesis/spec_usrgti_b.png}
            \end{flushleft}
          \end{minipage}
          \centering
          \begin{minipage}{0.8\textwidth}
...
%another chapter
  \chapter{Gamma-Ray Analysis}
      As mentioned before, because of the very short rotation periods, MSPs have very small light cylinder radii compared with
      normal pulsars. As a result, their emission mechanisms are similar to normal pulsars, especially for my objects ---
      PSRJ0218+4232, PSRJ1939+2134, PSRJ1821-2452 which are among the fastest spinning MSPs. Therefore, as normal pulsars,
      these three pulsars are bright in Gamma-Ray band and we can analyze the spectra properties of them in gamma-rays.
