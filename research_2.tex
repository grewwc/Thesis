...
\chapter{Data Analysis}
    ...
    \section{Data Analysis of Pulsar B1937+21 Using NuSTAR}
        ...
        \begin{figure}[!ht]
          \begin{minipage}{0.45\textwidth}
            \begin{center} 
                \includegraphics[scale=0.42]{/home/wwc129/Desktop/Thesis/region2_problem.png}
            \end{center}
            \end{minipage}
          \begin{minipage}{0.45\textwidth}
            \begin{center}
            \includegraphics[scale=0.42]{/home/wwc129/Desktop/Thesis/bkregion_3.png}
            \end{center}
          \end{minipage}
          \centering
          \begin{minipage}{0.8\textwidth}
        ...
        \begin{figure}[!ht]  
          \begin{minipage}{1\textwidth}
            \begin{center} 
                \includegraphics[scale=0.4]{/home/wwc129/Desktop/Thesis/lc_a_region3.png}
                \mycaption{Light curve of module A}
          ...
          \begin{minipage}{1\textwidth}
            \begin{center}
            \includegraphics[scale=0.4]{/home/wwc129/Desktop/Thesis/lc_b_region3.png}
            \mycaption{Light curve of module B}
        ...
        \begin{figure}[!ht]
          \begin{minipage}{0.45\textwidth}
            \begin{center} 
                \includegraphics[scale=0.45]{/home/wwc129/Desktop/Thesis/spec_a.png}
            \end{center}
            \end{minipage}
          \begin{minipage}{0.45\textwidth}
            \begin{center}
            \includegraphics[scale=0.45]{/home/wwc129/Desktop/Thesis/spec_b.png}
            \end{center}
          \end{minipage}
          \centering
          \begin{minipage}{0.8\textwidth}
        ...
        \begin{figure}[!ht] 
          \begin{minipage}{0.45\textwidth}
            \begin{flushleft} 
                \includegraphics[scale=0.45]{/home/wwc129/Desktop/Thesis/spec_usrgti_a.png}
            \end{flushleft}
            \end{minipage}
          \begin{minipage}{0.45\textwidth}
            \begin{flushleft}
            \includegraphics[scale=0.45]{/home/wwc129/Desktop/Thesis/spec_usrgti_b.png}
            \end{flushleft}
          \end{minipage}
          \centering
          \begin{minipage}{0.8\textwidth}
