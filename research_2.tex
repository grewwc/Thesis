...
\chapter{Data Analysis}
    ...
    \section{Data Analysis of Pulsar B1937+21 Using NuSTAR}
        ...
        \begin{figure}[h]
          ...
          \begin{minipage}{0.45\textwidth} 
            \centering 
            \includegraphics[scale=0.33]{/home/wwc129/Desktop/Thesis/A01.png}
            \caption{\textit{\footnotesize Sky image of module A}}
          \end{minipage}
          \hspace{0.1cm} 
          \begin{minipage}{0.52\textwidth}
            \centering 
            \includegraphics[scale=0.39]{/home/wwc129/Desktop/Thesis/B01.png}
        ...
        \begin{figure}[h]
          \begin{minipage}{0.45\textwidth} 
            \begin{flushright} 
            \includegraphics[scale=0.35]{/home/wwc129/Desktop/Thesis/A01_region.png}
            \end{flushright}
          \end{minipage}
          \hspace{2.1cm}  
          \begin{minipage}{0.45\textwidth}
            \begin{flushleft}
            \includegraphics[scale=0.42]{/home/wwc129/Desktop/Thesis/B01_region.png}
            \end{flushleft}
          \end{minipage}
          \begin{center}
        ...
        \begin{figure}[h]
          \begin{minipage}{1\textwidth}
            \begin{center}
                \includegraphics[scale=0.31]{/home/wwc129/Desktop/Thesis/A_lc.png}
         ...
         \\ 
          \begin{minipage}{\textwidth}
            \centering
            \includegraphics[scale=0.34]{/home/wwc129/Desktop/Thesis/B_lc.png}
        ...
        the column density between module A and B are huge (module A is about 400 times larger than module B). This 
        ...
        \begin{figure}[!ht]
          \begin{minipage}{0.45\textwidth}
            \begin{flushleft} 
                \includegraphics[scale=0.45]{/home/wwc129/Desktop/Thesis/a_1.png}
            \end{flushleft}
            \end{minipage}
          \begin{minipage}{0.45\textwidth}
            \begin{flushleft}
            \includegraphics[scale=0.52]{/home/wwc129/Desktop/Thesis/b_1.png}
            \end{flushleft}
          \end{minipage}
          \centering
          \begin{minipage}{0.8\textwidth}
        ...
        We do not change the radius of the source region so the radius is still 23 arcseconds. Secondly, we change the
        ...
        4 detectors. Thirdly, we change the shape of background region from a circle to an annulus. The aim is to 
        make the background region surround the observed source to be more like the background of the source.\\ 
        \begin{figure}[!ht]
          \begin{minipage}{0.45\textwidth}
            \begin{center} 
                \includegraphics[scale=0.36]{/home/wwc129/Desktop/Thesis/A_region2.png}
            \end{center}
            \end{minipage}
          \begin{minipage}{0.45\textwidth}
            \begin{center}
            \includegraphics[scale=0.42]{/home/wwc129/Desktop/Thesis/B_region2.png}
            \end{center}
          \end{minipage}
          \centering
          \begin{minipage}{0.8\textwidth}
        ...
        \end{figure}
        \\
        \indent The figures \ref{fig:a_1_region2_lightcurve} and \ref{fig:b_1_region2_lightcurve} are the light 
        curves 
        ...
        --- there are also some spikes in the light curves. \\
        \begin{figure}[!ht] 
          \begin{minipage}{1\textwidth}
            \begin{center} 
                \includegraphics[scale=0.4]{/home/wwc129/Desktop/Thesis/a_1_region2_lightcurve.png}
                \mycaption{Light curve of module A}
                \label{fig:a_1_region2_lightcurve}
            \end{center}
            \end{minipage}
            \\
          \begin{minipage}{1\textwidth}
            \begin{center}
            \includegraphics[scale=0.4]{/home/wwc129/Desktop/Thesis/b_1_region2_lightcurve.png}
            \mycaption{Light curve of module B}
            \label{fig:b_1_region2_lightcurve}
            \end{center}
          \end{minipage}
          \centering
        \end{figure}
        ...
        \begin{table}[!h]   
          ...
          \begin{tabular}{| m{4cm} | m{3cm} | m{3cm} |}
            ...
            & Module A & Module B \\
            \hline
            Column Density (nH) ($10^{22} atoms/cm^2$) & 0.0054 & 0.0020\\ 
            \hline
            Photon Index ($\Gamma$) & 1.11 & 1.51 \\
            \hline 
            Reduced Chi Square Statistic & 0.73 & 0.51 \\
            \hline 
          \end{tabular}
          \mycaption{Fitting result}
          \label{table:parameter_region2}
        \end{table}

        The figure \ref{fig:spectra_region2} is the spectra of module A and B. The table \ref{table:parameter_region2}
        ...
        by our model, which generally is a better result. We keep using this set of source and background regions
        for now. \\

        \begin{figure}[!ht]
          \begin{minipage}{0.45\textwidth}
            \begin{center} 
                \includegraphics[scale=0.45]{/home/wwc129/Desktop/Thesis/a_1_region2_spectrum.png}
            \end{center}
            \end{minipage}
          \begin{minipage}{0.45\textwidth}
            \begin{center}
            \includegraphics[scale=0.45]{/home/wwc129/Desktop/Thesis/b_1_region2_spectrum.png}
            \end{center}
          \end{minipage}
          \centering
          \begin{minipage}{0.8\textwidth}
          \mycaption{Spectra of module A (left) and B (right). The total source counts of A before grouping is 
                      264 and B is 254. After subtracting the background counts, the source counts are 181.64 (A)
                      and 157.90 (B). Reduced chi square statistic: 0.73 (A) and 0.51 (B).}
          \label{fig:spectra_region2}
          \end{minipage}
          \end{figure}
             
        \indent
        Now we consider using our own GTI file to filter the light curves we get before in order to get rid of 
        spikes.
        ...
        \begin{figure}[!ht] 
          \begin{minipage}{1\textwidth}
            \begin{center} 
                \includegraphics[scale=0.42]{/home/wwc129/Desktop/Thesis/a_gti.png}
          ...
          \begin{minipage}{1\textwidth}
            \begin{center}
            \includegraphics[scale=0.42]{/home/wwc129/Desktop/Thesis/b_gti.png}
