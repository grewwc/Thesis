...
\chapter{Data Analysis}
    ...
    \section{Data Analysis of Pulsar B1937+21 Using NuSTAR}
        ...
        23 arcsecond. The data of the source region center is from
        ...
        We do not change the radius of the source region so the radius is still 23 arcsecond. Secondly, we change the
        position of the background region and make it in the same region with the observed source. This is because 
